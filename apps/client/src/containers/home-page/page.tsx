...
export default function HomePage() {
  ...
  return (
    <div className="bg-gray-200 pt-16 backdrop-blur-2xl">
      <div className="py-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-gray-600">
          Luôn cập nhật những hợp âm mới nhất
        </p>
      </div>
      {isLoading && (
          ...
          <PaginationContent>
            <PaginationItem>
              <PaginationPrevious
                ...
                onClick={() =>
                  currentPage > 1 &&
                  route.push(`/songs?page=${currentPage - 1}`)
                }
              />
            </PaginationItem>

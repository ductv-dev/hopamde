...
const badgeVariants = cva(
  'focus:outline-hidden focus:ring-ring inline-flex items-center justify-center border border-transparent font-medium focus:ring-2 focus:ring-offset-2 [&_svg]:-ms-px [&_svg]:shrink-0',
  {
    variants: {
      variant: {
